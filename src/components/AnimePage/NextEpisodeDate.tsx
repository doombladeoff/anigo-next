...
function NextEpisode({ nextEpisodeAt }: { nextEpisodeAt: string }) {
    ...
    return (
        <motion.div
            ...
            className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-2 p-4 rounded-2xl bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg text-white"
        >
            {/* Иконка + текст */}
            ...
            {/* Дата и дни до выхода */}
            <span className="font-medium text-sm md:text-base text-white/80">
